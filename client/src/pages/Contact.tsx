            ...
            <div className="lg:col-span-2 bg-[#1e3a5f] py-16 px-10 flex flex-col divide-y divide-white/10">
              ...
              <div className="pb-10">
                ...
                <p className="text-white/60 text-[13px] leading-relaxed">
                  {isFr
                    ? "Conseillère en relations industrielles agréée avec 16 ans d'expérience. Audrey met son expertise au service des organisations, entrepreneurs et artistes en les accompagnant dans la structuration de leurs projets, l'optimisation de leurs pratiques et l'accès stratégique aux subventions des bailleurs de fonds."
