              ...
              <Card className="p-6 card-hover-lift border-2 border-accent bg-gradient-to-b from-accent/5 to-transparent relative overflow-hidden shadow-lg" data-testid="card-package-essential">
                ...
                <ul className="space-y-3 mb-4">
                  <li className="flex items-start gap-2">
                    ...
                    <div>
                      <span className="text-sm font-medium">{t("packages.essential.feature1")}</span>
                      <p className="text-xs text-muted-foreground">{t("packages.essential.feature1Detail")}</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="text-sm font-medium">{t("packages.essential.feature2")}</span>
                      <p className="text-xs text-muted-foreground">{t("packages.essential.feature2Detail")}</p>
                    </div>
                  </li>
                  <li className="flex items-start gap-2">
                    <CheckCircle className="w-5 h-5 text-accent flex-shrink-0 mt-0.5" />
                    <div>
                      <span className="text-sm font-medium">{t("packages.essential.feature3")}</span>
                      <p className="text-xs text-muted-foreground">{t("packages.essential.feature3Detail")}</p>
                    </div>
                  </li>
                </ul>
              </Card>
